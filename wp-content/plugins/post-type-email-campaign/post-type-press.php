 ...
 *
 */
require_once( plugin_dir_path( __FILE__ ) . 'public/class-post-type-email-campaign.php' );
...
if ( is_admin() && ( ! defined( 'DOING_AJAX' ) || ! DOING_AJAX ) ) {
	...
	require_once( plugin_dir_path( __FILE__ ) . 'admin/class-post-type-email-campaign-admin.php' );
